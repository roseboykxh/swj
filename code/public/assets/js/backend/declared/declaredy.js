define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'declared/declaredy/index',
                    add_url: 'declared/declaredy/add',
                    edit_url: 'declared/declaredy/edit',
                    del_url: 'declared/declaredy/del',
                    multi_url: 'declared/declaredy/multi'
                }
            });
