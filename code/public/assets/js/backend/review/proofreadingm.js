define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'review/proofreadingm/index',
                }
            });
            var table = $("#table");
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'nickname',  title: '录入人员',searchList: $.getJSON("review/proofreadingm/getjson")},
                        {field: 'nickname1',  title: '校验人员',operate: false},
                        {field: 'add_time',  title: '创建时间',operate: false},
                        {field: 'set_time',  title: '指定月报时间',operate: false},
                        {
                            field: 'buttons',
                            width: "120px",
                            title: __('操作'),
