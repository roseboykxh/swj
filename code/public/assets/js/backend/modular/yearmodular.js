define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'modular/yearmodular/index',
                    add_url: 'modular/yearmodular/add',
                    edit_url: 'modular/yearmodular/edit',
                    del_url: 'modular/yearmodular/del',
                    multi_url: 'modular/yearmodular/multi'
                }
            });
